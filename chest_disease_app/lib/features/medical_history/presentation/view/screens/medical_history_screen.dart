...
import 'package:chest_disease_app/features/medical_history/presentation/view/widgets/scan_row.dart';
      ...
      body: BlocBuilder<MedicalHistoryCubit, MedicalHistoryState>(
        builder: (context, state) {
          ...
          if (state is MedicalHistoryError) {
            return const Center(child: Text('Error loading medical scans'));
          }
