...
import 'package:chest_disease_app/features/reports/presentation/view_model/reports_cubit.dart';
import 'package:chest_disease_app/features/slots/presentation/view_model/slots_cubit.dart';
import 'package:chest_disease_app/features/view_patients/presentation/view/screens/view_patients_screen.dart';
  ...
  void initializeDoctorTabs() {
    tabs.addAll([
      ...
      BlocProvider(
        ...
        child: const ViewPatientsScreen(),
      ),
      BlocProvider(
