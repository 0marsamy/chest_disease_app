        ...
        child: BlocConsumer<EditProfileCubit, EditProfileState>(
          listener: (context, state) {
            if (state is EditProfileSuccess) {
              S.of(context).profileUpdatedSuccessfully.showToast();
            }
            if (state is EditProfileError) {
              S.of(context).failedToUpdateProfile.showToast();
            }
          },
                ...
                children: [
                  CustomTextField(
                    ...
                    validator: (value) => checkFieldValidation(
                      val: cubit.nameController.text.trim(),
                  ...
                  CustomTextField(
                    ...
                    validator: (value) => checkFieldValidation(
                      val: cubit.userNameController.text.trim(),
