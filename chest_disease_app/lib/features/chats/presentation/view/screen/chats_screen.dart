...
import 'package:chest_disease_app/features/chats/presentation/view/widgets/custom_messages_text_field.dart';
import 'package:chest_disease_app/features/chats/presentation/view_model/chats_cubit.dart';
...
class ChatsScreen extends StatefulWidget {
  const ChatsScreen({super.key, required this.chat});
...
class _AnimatedMessageBubbleState extends State<AnimatedMessageBubble>
  ...
  void initState() {
    ...
    _slideAnimation = Tween<Offset>(
      begin: isMyMessage ? const Offset(0.3, 0.0) : const Offset(-0.3, 0.0),
      end: Offset.zero,
    ).animate(CurvedAnimation(
      parent: _controller,
