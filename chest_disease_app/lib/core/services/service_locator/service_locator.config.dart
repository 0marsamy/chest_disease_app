...
import '../../../features/scan/data/repo/upload_scan_repository_impl.dart'
    as _i597;
import '../../../features/scan/domain/repo/upload_scan_repository.dart'
    as _i727;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i860.AppDio>(() => _i860.AppDio());
    ...
    gh.factory<_i4.EditProfileCubit>(
        () => _i4.EditProfileCubit(repository: gh<_i461.EditProfileRepo>()));
    ...
    gh.factory<_i942.ScanCubit>(
        () => _i942.ScanCubit(gh<_i727.UploadScanRepository>()));
