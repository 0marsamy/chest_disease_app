...
import 'package:chest_disease_app/features/view_patients/presentation/view/widgets/view_patient_row.dart';
        ...
        builder: (context, state) {
          return CustomScrollView(
            slivers: [
              ...
              const SliverToBoxAdapter(child: DateRangeSelector()),
